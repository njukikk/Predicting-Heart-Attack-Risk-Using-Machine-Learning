...
Different models were built, and the best model for predicting the chances of getting a heart attack was selected based on the accuracy metric. The project used heart attack data that was extracted from kaggle.com URL: https://www.kaggle.com/rashikrahmanpritom/heart-attack-analysis-prediction-dataset. The data contains 14 variables (13 predictors and one response variable (`output`)). The description of each variable is outlined below.
